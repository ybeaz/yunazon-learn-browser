...
export const handleEvents: Function = (event: any, props: Props): void => {
  ...
  const output = {
    ...
    SET_OAUTH_STATE: () => {
      dispatch(actionSync.SET_OAUTH_STATE(data))
    },
    ...
    CLICK_AUTH_FACEBOOK: () => {
      handleEvents(
        {},
        { typeEvent: 'SET_OAUTH_STATE', data: 'CLICKED_AUTH_FACEBOOK' }
      )
    ...
    CLICK_AUTH_VKONTAKTE: () => {
      handleEvents(
        {},
        { typeEvent: 'SET_OAUTH_STATE', data: 'CLICKED_AUTH_VKONTAKTE' }
      )
      dispatch(actionSync.SET_MODAL_FRAMES([]))
      const data = [
        {
    ...
    CLICK_AUTH_GOOGLE: () => {
      handleEvents(
        {},
        { typeEvent: 'SET_OAUTH_STATE', data: 'CLICKED_AUTH_GOOGLE' }
      )
      dispatch(actionSync.SET_MODAL_FRAMES([]))
      const data = [
        {
